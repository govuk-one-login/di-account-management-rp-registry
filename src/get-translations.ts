...
const convertToTranslation = (translations: Client["translations"]["en"], environment: string): Translation => {
    return {
...
const getTranslations = (environment: string, language: 'en' | 'cy'): TranslationsObject => {
